...
import { fetchRestaurantReviews } from '../services/googleMapsService';
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      if (selectedRestaurantId) {
        ...
        if (restaurant && restaurant.isRealData) {
          const fetchedReviews = await fetchRestaurantReviews(restaurant.id.replace('real-', ''));
        ...
        <div className="space-y-2">
          {restaurants.map((restaurant, index) => (
            ...
            >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <div className="flex items-center text-gray-600">
                      {Array.from({ length: restaurant.priceLevel }).map(
                        (_, i) => (
              ...
              {selectedRestaurantId === restaurant.id && reviews.length > 0 && (
                <div className="mt-2 p-2 bg-gray-100 rounded-lg shadow-md">
                  <h4 className="font-semibold text-sm mb-1">口コミ</h4>
